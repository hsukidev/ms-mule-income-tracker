...
> **Dev:** "What about **Party Size** — if I run with 3 players, does the **Crystal Value** get divided?"
> **Domain expert:** "Yes, the actual earned mesos = **Crystal Value** / **Party Size**. But **Potential Income** assumes solo (party size 1) for now. Party division is a future enhancement."
